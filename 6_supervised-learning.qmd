...
In this session, we will use the tidymodels framework, which wraps many common algorithms and promises to unify the sytanx.
...
str_count("This is a test: what? Did you hear, me.\ntest" ,"\\S+")
```
